...
3. Go to **Tools → Notipo SEO Meta Writer**. The page shows which SEO plugin was detected.
...
1. Go to **Tools → Notipo SEO Meta Writer**.
...
The **Tools → Notipo SEO Meta Writer** page prints this same command with your own site URL already filled in.
...
= 1.1.2 =
* Text domain changed to `notipo-seo-meta-writer` to match the assigned plugin slug, so the strings can be translated through the directory's tools.

= 1.1.1 =
* Display name changed to "Notipo SEO Meta Writer".

= 1.1.0 =
* Added a **Tools → Notipo SEO Meta Writer** screen showing which SEO plugin was detected, a form for writing the three fields to a post, and a table reading the values back out of the SEO plugin's own fields.
